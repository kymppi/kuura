...
type Config struct {
	...
	USER_CODE_SECRET_KEY_PATH string `env:"USER_CODE_SECRET_KEY_PATH" envDefault:"/var/kuura/.user-code"`
	...
	PUBLIC_KUURA_DOMAIN string `env:"PUBLIC_KUURA_DOMAIN" envDefault:"kuura.example.com"`
}
